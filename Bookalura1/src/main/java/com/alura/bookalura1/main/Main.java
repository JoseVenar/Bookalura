package com.alura.bookalura1.main;

import com.alura.bookalura1.modelos.Author;
import com.alura.bookalura1.modelos.DatosLibro;
import com.alura.bookalura1.modelos.Libro;
import com.alura.bookalura1.repository.AuthorRepository;
import com.alura.bookalura1.repository.LibroRepository;
import com.alura.bookalura1.services.ConvierteDatos;
import com.alura.bookalura1.services.RequestAPI;
...
public class Main {
    ...
    private void buscarLibro()
    {
        ...
        try {
            ...
            Author autor = new Author(datosLibro.resultados().get(0).autorList().get(0));
